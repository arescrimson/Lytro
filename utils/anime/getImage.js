...
const { createAnimeImageEmbed } = require('../embed/createAnimeEmbeds');
...
class AnimeImageSearch {
    ...
    async createAnimeImagesEmbed() {
        ...
        try {
            ...
            const pictureLink = this.animeImageArray[randomImageIndex].webp.default.href;

            this.animeImageEmbed = createAnimeImageEmbed(anime.title.default, pictureLink);
